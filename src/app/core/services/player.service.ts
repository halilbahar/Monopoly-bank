...
export class PlayerService {
  ...
  constructor() {
    const playersStorage = localStorage.getItem('monopoly-bank.players');
  ...
  setPlayers(players: Player[]): void {
    ...
    localStorage.setItem('monopoly-bank.players', JSON.stringify(this.players.value));
  }
  ...
  clearGame(): void {
    this.players.next([]);
    localStorage.removeItem('monopoly-bank.players');
  }
}
